...
- `plan-ingestion-workflow`: ordered package-specific command plan from characterization through OCR/VLM, embeddings, retrieval cases, retrieval-quality/cost/latency-gated chunking comparison, index refresh, metadata refresh, and ingestion readiness.
