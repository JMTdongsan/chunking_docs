...
- `plan-ingestion-workflow`: ordered package-specific command plan from characterization through OCR/VLM, embeddings, retrieval cases, chunking comparison, and ingestion readiness.
