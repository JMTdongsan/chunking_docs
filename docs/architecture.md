...
- `sweep-qdrant-fusion`: grid search over Qdrant, BM25, exact vector-source, and graph fusion weights with eligibility gates, latency-aware selection scores, and a recommended production retrieval configuration.
